    ...
    <div className="sl-page animate-fadeIn">
      <PageHeader
        ...
        stats={[
          ...
          { label: 'Active', value: accounts.filter((account) => account.status === 'active').length, tone: 'lime' },
          { label: 'Certificates', value: certificates.length, tone: 'sky' },
          { label: 'App IDs', value: appIds.length, tone: 'amber' },
        ]}
      />
